...
@section('content')
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
            <h1>
              Selamat datang <br />
              <span>Sobat Sehat</span>
            </h1>

            <span></span>
            <h2>Layanan Informasi Kegiatan Sehat Masyarakat</h2>
            <div class="d-flex justify-content-center justify-content-lg-start">
              <a href="#about" class="btn-get-started scrollto">Temukan Kegiatan</a>
            </div>
          </div>
    ...
    <main id="main">
      ...
      <div class="section-title">
        <h2>Mitra Kami</h2>
        <p>Beberapa mitra yang telah berkerja sama dengan kami</p>
      </div>
      <section id="clients" class="clients section-bg">
        <div class="container">
          <div class="row" data-aos="zoom-in">
            <div class="col-lg-3 col-md-4 col-6 d-flex align-items-center justify-content-center">
              <img src="{{asset('img/partners/kemenkes.svg')}}" class="img-fluid" alt="" />
            </div>

            <div class="col-lg-3 col-md-4 col-6 d-flex align-items-center justify-content-center">
              <img src="{{asset('img/partners/halodoc.png')}}" class="img-fluid" alt="" />
            </div>

            <div class="col-lg-3 col-md-4 col-6 d-flex align-items-center justify-content-center">
              <img src="{{asset('img/partners/pocari.png')}}" class="img-fluid" alt="" />
            </div>

            <div class="col-lg-3 col-md-4 col-6 d-flex align-items-center justify-content-center">
              <img src="{{asset('img/partners/Logo-Jabar-10K_warna.png')}}" class="img-fluid" alt="" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="services" class="services section-bg pb-3">
        <div  class="container text-center" data-aos="fade-up">
          <div class="section-title">
            <h2>Untuk siapa Sobat Sehat?</h2>
            <p>Kelola seluruh komunitas Anda dalam satu sistem</p>
          </div>
          <!-- style="background-color: #18d26e;" -->
          <div  class="row justify-content-center pt-5">
            <div class="col-xl-3 col-md-4 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box">
                <img class="mb-3" src="{{asset('img/card-untuk-siapa/mu.png')}}" alt="">
                <h4>Masyarakat
                  Umum</h4>
                <p>Individu dari berbagai lapisan masyarakat yang mencari informasi kesehatan dan tertarik untuk meningkatkan kesadaran dan praktik kesehatan</p>
              </div>
            </div>
            <div class="col-xl-3 col-md-4 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box">
                <img class="mb-3" src="{{asset('img/card-untuk-siapa/ik.png')}}"   alt="">
                <h4>Instansi Kesehatan</h4>
            ...
            <div class="col-xl-3 col-md-4 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box">
                <img class="mb-3" src="{{asset('img/card-untuk-siapa/pk.png')}}" alt="">
                <h4>Penggiat Kesehatan</h4>
                <p>Pihak yang berkepentingan dalam menyebarkan informasi kesehatan kepada masyarakat luas, termasuk pemerintah daerah, lembaga kesehatan, dan organisasi non-profit.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <!-- ======= Why Us Section ======= -->
      <section id="why-us" class="why-us section-bg mt-5 mb-5">
        <div class="container-fluid" data-aos="fade-up">
          <div class="row">
            <div class="col-lg-5  align-items-end  order-1 order-lg-1 img" data-aos="zoom-in" data-aos-delay="150">&nbsp; 
              <img class="ms-5"  src="{{asset('img/about-us.png')}}"alt=""> 
            </div>
            <div class="col-lg-7 d-flex flex-column justify-content-center align-items-stretch order-2 order-lg-2">
              <div class="content">
                <h3>Tentang Sobat Sehat</h3>
                <p>Aplikasi sobat sehat dirancang sebagai solusi inovatif untuk meningkatkan partisipasi dalam kegiatan sehat masyarakat. Dengan menyediakan informasi yang komprehensif dan relevan, aplikasi ini mempermudah pengguna dalam menemukan acara kegiatan sehat masyarakat yang sesuai dengan minat dan kebutuhan mereka.</p>
                <div>
        ...
        <div class="container" data-aos="zoom-in">
          <div class="row">
            <div class="col-lg-9 text-center text-lg-start">
              <h3>
                Membantu penggiat mempublikasikan <br />
                <span>informasi kegiatan mereka</span>
              </h3>
              <p>Pencapaian kerja keras dan dedikasi kami sampai saat ini.</p>
            </div>
      ...
      <section id="why-us" class="why-us section-bg mt-5 mb-5">
        <div class="container-fluid" data-aos="fade-up">
          <div class="row">
            <div class="col-lg-5  align-items-end  order-1 order-lg-1 img" data-aos="zoom-in" data-aos-delay="150">
              <img class="ms-5"  src="{{asset('img/publish.png')}}"alt=""> 
            </div>
            <div class="col-lg-7 d-flex flex-column justify-content-center align-items-stretch order-2 order-lg-2">
              <div class="content">
                <h3>Bagaimana anda bisa mempublikasikan kegiatan anda?</h3>
                <p>Untuk mempublikasikan kegiatan Anda di website kami, langkah pertama yang perlu Anda lakukan adalah mendaftar sebagai kontributor. Proses ini melibatkan pengisian formulir pendaftaran yang dapat Anda temukan di halaman <a href="#">Sign Up</a>. Setelah mengirimkan formulir, Anda akan menerima pemberitahuan bahwa akun Anda telah berhasil terdaftar. Namun, sebelum dapat mengisi form acara kegiatan, akun Anda perlu divalidasi oleh admin kami. Setelah proses validasi selesai, Anda akan mendapatkan akses penuh untuk mempublikasikan kegiatan Anda melalui pengisian formulir yang telah disediakan.</p>
                <div>
                  <button type="button" class="btn btn-success">Bergabung</button>
                </div>
              </div>
            </div>
          </div>
